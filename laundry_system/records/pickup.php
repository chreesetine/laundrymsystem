...
$query = "SELECT t.transaction_id, c.customer_id, c.customer_name, sr.laundry_service_option, sr.laundry_category_option,
          sr.quantity, sr.service_request_date, sr.request_date, sr.order_status, sr.remarks
          FROM transaction t JOIN customer c ON t.customer_id = c.customer_id
          JOIN service_request sr ON t.request_id = sr.request_id
          WHERE t.service_option_name = 'customer pick-up' AND sr.remarks IN ('claimed', 'unclaimed', 'pending')
        ...
        <div class="main-content">
            <nav>
                <div class="d-flex justify-content-between" id="navbar">
                    ...
                    <div class="search_bar" m-1>
                        <input class="form-control" type="text" id="filter_pickup" placeholder="Search pick-up logs...">
                    </div>    
                </div>
            </nav>
            ...
            <div class="buttons">
                ...
                <div class="pickup_button">
                    <a href="pickup.php" class="button" id="pickupBtn"><b>Pick-up</b></a>
                </div> 
            </div> <!-- buttons -->
